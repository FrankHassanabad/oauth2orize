...
// token request for verification. If these values are validated, the
...
// Exchange the refresh token for an access token.  The callback accepts the `client`, which
// is exchanging the client's id from the token request for verification.  If this value is
// validated, the application issues an access token on behalf of the client who authorized
// the code
